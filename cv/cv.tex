...
\cvitem{}{Enumerative geometry of hyperbolic / translation / square-tiled surfaces, moduli spaces of curves and differentials, Masur--Veech volumes, intersection theory, Hurwitz numbers. \newline 
Particular interest in related combinatorial structures: ribbon graphs (combinatorial maps), cellular decompositions of moduli spaces, polytopes, hyperplane arrangements, curve complexes, mapping class groups. I am also interested in algorithmic problems on surfaces and I enjoy experimenting in SageMath.}
...
\cvitem{}{\small{\textbf{Algorithms for length spectra of combinatorial tori},\newline
\emph{with V. Delecroix, M. Ebbens, F. Lazarus.}
\newline Journal of Computational Geometry 15 (2):57-93. 
\newline DOI link: \url{https://doi.org/10.20382/jocg.v15i2a3}
\newline Arxiv link: \url{https://arxiv.org/abs/2303.08036}
\newline Extended abstract: 39th International Symposium on Computational Geometry (SoCG 2023),
\newline Vol. 258 of Leibniz International Proceedings in Informatics (LIPIcs), pages 26:1–26:16.
\newline DOI link: \url{https://doi.org/10.4230/LIPIcs.SoCG.2023.26}}
}

\section{Talks}
\cvitem{Mar 2026}{Oberseminar, \emph{MPIM, Bonn}.}
\cvitem{Feb 2026}{Geometry seminar, \emph{MPI MiS, Leipzig}.}
\cvitem{Oct 2025}{Gravity seminar, \emph{IMAPP, Radboud University, Nijmegen}.}
\cvitem{Jul 2025}{Low-dimensional topology seminar, \emph{MPIM, Bonn}.}
...
\section{Visits}
\cvitem{Feb 2026}{MPI MiS, Leipzig (1 week).}
\cvitem{Oct 2025}{IMAPP, Radboud University, Nijmegen (1 week).}
...
\cvitem{2026}{Co-organization of the Reading group on spectral geometry, MPIM (Bonn). \newline
		\small{link: \url{https://iyakovlev23.github.io/spec_geom_26.html}}}
...
\cvitem{Jun 2026}{IMJ-PRG Summer School ''Integrable Combinatorics'', Paris.}
\cvitem{Jun 2026}{CMI-HIMR Summer School on Random Geometries and Random Matrices, Bristol.}
\cvitem{Aug 2025}{Workshop ``Combinatorial and hyperbolic random planar geometry'', CIRM, Marseille.}
\cvitem{Jul 2025}{Conference ``Dynamics and rigidity'', Cetraro.}
\cvitem{Jun 2025}{Conference ``Degenerations of Flat Surfaces and Rational Maps'', Toulouse.}
\cvitem{Jun 2025}{Summer school on Dynamics and Geometry, CIRM, Marseille.}
